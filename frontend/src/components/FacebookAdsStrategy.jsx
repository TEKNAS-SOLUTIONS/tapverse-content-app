  ...
  if (loading && strategies.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-4 text-gray-600">Loading Facebook Ads strategies...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Facebook & Instagram Ads Strategy</h2>
      ...
      {strategies.length === 0 && !generating && (
        <div className="text-center py-12 bg-white rounded-xl border border-gray-200 shadow-sm">
          <p className="text-gray-600 mb-4">No Facebook Ads strategies generated yet</p>
          <p className="text-gray-500 text-sm mb-6">Comprehensive social media advertising strategies powered by Claude</p>
          <button
            onClick={generateStrategy}
